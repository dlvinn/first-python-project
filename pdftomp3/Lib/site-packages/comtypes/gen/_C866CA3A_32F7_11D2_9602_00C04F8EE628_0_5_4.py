...
__all__ = [
    'ISpeechPhraseAlternate', 'SAFTADPCM_11kHzStereo',
    'SPPS_Noncontent', 'DISPID_SpeechRecognizerStatus',
    'SVSFPersistXML', 'DISPID_SPEsCount', 'DISPID_SOTCategory',
    'eLEXTYPE_PRIVATE2', 'DISPID_SpeechPhraseInfo', 'SPEVENT',
    ...
    'SPWORDTYPE', 'SVP_15', 'SBONone', 'DISPID_SOTCGetDataKey',
    'Speech_Default_Weight', 'DISPID_SOTCDefault',
    'SPPS_NotOverriden', 'DISPID_SPRDisplayAttributes',
    'STCInprocServer', 'SASStop', 'eLEXTYPE_PRIVATE1',
    'DISPID_SVAllowAudioOuputFormatChangesOnNextSet',
    'SPEI_ACTIVE_CATEGORY_CHANGED', 'DISPID_SVGetProfiles',
    'DISPID_SRSAudioStatus', 'DISPID_SRCEventInterests',
    'DISPID_SRCPause', 'SpAudioFormat', 'SPEI_RESERVED3',
    'SPAUDIOOPTIONS', 'ISpeechRecoResultTimes', 'DISPID_SOTDataKey',
    'DISPID_SpeechPhraseProperties', 'SP_VISEME_1', 'DISPID_SOTSetId',
    'DISPIDSPTSI_SelectionLength', 'eLEXTYPE_RESERVED7',
    'DISPID_SpeechCustomStream', 'SPAS_CLOSED',
    'DISPID_SRSClsidEngine', 'SpMMAudioEnum', 'SREStreamEnd',
    'SPINTERFERENCE_LATENCY_TRUNCATE_END', 'SPINTERFERENCE_NONE',
    'SAFTNonStandardFormat', 'DISPID_SpeechBaseStream',
    'DISPID_SRRTimes', 'SAFT11kHz8BitStereo',
    'SPRST_INACTIVE_WITH_PURGE', 'SAFTADPCM_22kHzStereo',
    'SRSEIsSpeaking', 'DISPID_SRGIsPronounceable', 'SVEPhoneme',
    'DISPID_SOTCSetId', 'DISPID_SWFESamplesPerSec',
    'Speech_StreamPos_RealTime', 'DISPID_SPAsCount',
    'SpeechGrammarWordType', 'ISpeechFileStream',
    'DISPID_SPERetainedSizeBytes', 'DISPID_SLPPhoneIds',
    'SPEI_SR_AUDIO_LEVEL', 'DISPID_SPRsItem', 'DISPIDSPTSI',
    'SpeechLexiconType', 'DISPID_SGRs_NewEnum', 'SVP_17',
    'DISPID_SPEAudioSizeBytes', 'SVEWordBoundary',
    'DISPID_SRRTTickCount', 'DISPID_SpeechFileStream',
    'DISPID_SWFEBitsPerSample', 'DISPID_SRRSetTextFeedback',
    'DISPID_SGRsAdd', 'SPWT_DISPLAY', 'SpeechGrammarTagWildcard',
    'DISPID_SVAlertBoundary', 'eLEXTYPE_PRIVATE14', 'ISpRecoGrammar',
    'eLEXTYPE_LETTERTOSOUND', 'ISpRecoResult', 'DISPID_SLWWord',
    'DISPID_SLGenerationId', 'SPXRO_Alternates_SML',
    'eLEXTYPE_PRIVATE5', 'ISpEventSink', 'SVSFParseSsml',
    'DISPID_SPELexicalForm', 'ISpeechTextSelectionInformation',
    'DISPID_SPCIdToPhone', 'SPEI_MIN_TTS', 'eLEXTYPE_PRIVATE3',
    'SPSHT_OTHER', 'SPRST_ACTIVE', 'SVP_12', 'SAFTADPCM_44kHzStereo',
    'SASClosed', 'DISPID_SpeechGrammarRuleStateTransitions',
    'SPEI_TTS_AUDIO_LEVEL', 'SAFT16kHz16BitStereo',
    'SPWORDPRONUNCIATION', 'ISpeechVoice', 'SAFT11kHz16BitStereo',
    'SREPropertyNumChange', 'SPEI_MAX_SR', 'SPEI_END_INPUT_STREAM',
    'SPEI_ADAPTATION', 'SpeechBookmarkOptions', 'eLEXTYPE_PRIVATE16',
    'SECLowConfidence', 'DISPID_SPIRule', 'DISPID_SGRsDynamic',
    'eLEXTYPE_PRIVATE18', 'DISPID_SLWsCount',
    'DISPID_SpeechObjectTokens', 'SPEI_RECO_STATE_CHANGE',
    'SITooLoud', 'SpeechDisplayAttributes', 'eLEXTYPE_PRIVATE7',
    'DISPID_SPAs_NewEnum', 'SpLexicon', 'ISpObjectTokenCategory',
    'DISPID_SOTId', 'SpeechRecoContextState', 'SPXRO_SML',
    'DISPID_SpeechDataKey', 'ISpeechRecoResult2',
    'DISPID_SRSCurrentStreamNumber', 'SPPROPERTYINFO',
    'ISpNotifySink', 'DISPID_SPPValue', 'SGDSActiveUserDelimited',
    'DISPID_SABufferInfo', 'DISPID_SRRDiscardResultInfo',
    'ISequentialStream', 'SPEI_HYPOTHESIS',
    'SAFTCCITT_uLaw_11kHzMono', 'DISPID_SWFEBlockAlign',
    'DISPID_SpeechLexicon', 'SpVoice', 'DISPID_SOTIsUISupported',
    'DISPID_SVSLastBookmark', 'STCAll', 'DISPID_SGRSTText',
    'ISpProperties', 'SpeechPropertyNormalConfidenceThreshold',
    'DISPID_SLAddPronunciationByPhoneIds', 'SpCustomStream',
    'DISPID_SRGCmdLoadFromProprietaryGrammar', 'SP_VISEME_15',
    'ISpPhrase', 'SpeechCategoryPhoneConverters',
    'DISPID_SGRSTPropertyName', 'DISPIDSPTSI_SelectionOffset',
    'SVP_3', 'ISpEventSource', 'DISPID_SMSALineId',
    'SpeechRuleAttributes', 'SpeechCategoryAppLexicons', 'SVEViseme',
    'SpeechInterference', 'DISPID_SPRFirstElement',
    'SAFT44kHz16BitStereo', 'SpeechTokenValueCLSID',
    'SPEI_SR_PRIVATE', 'SVP_0', 'SBOPause', 'DISPID_SRCState',
    'SPPS_RESERVED3', 'ISpeechPhraseReplacement',
    'DISPID_SVSInputWordPosition', 'ISpeechVoiceStatus',
    'SPRS_INACTIVE', 'DISPID_SLGetGenerationChange',
    ...
    'UINT_PTR', 'DISPID_SPILanguageId', 'DISPID_SLPType',
    'DISPID_SPRs_NewEnum', 'DISPID_SRRRecoContext',
    'SAFTGSM610_44kHzMono', 'SPEI_PHONEME',
    'DISPID_SRAllowVoiceFormatMatchingOnNextSet', 'SPSNoun',
    'SAFTADPCM_8kHzStereo', 'SP_VISEME_3', 'SRSActiveAlways',
    'SRADynamic', 'SpeechSpecialTransitionType',
    'DISPID_SPIAudioSizeTime', 'DISPID_SPIGetDisplayAttributes',
    'ISpeechLexiconWords', 'SRSEDone',
    'DISPID_SpeechPhraseReplacements', 'DISPID_SpeechXMLRecoResult',
    'SGDSActiveWithAutoPause', 'SPRS_ACTIVE_WITH_AUTO_PAUSE',
    'DISPID_SRSSupportedLanguages', 'SPWORD', 'SRSInactive',
    'SpSharedRecoContext', 'SRERecoOtherContext',
    'Speech_StreamPos_Asap', 'DISPID_SPISaveToMemory',
    'DISPID_SPEEngineConfidence', 'DISPID_SRCERequestUI',
    'SAFT48kHz16BitStereo', 'SAFTADPCM_44kHzMono',
    'eLEXTYPE_VENDORLEXICON', 'SPVPRI_ALERT', 'DISPID_SRAudioInput',
    'eLEXTYPE_PRIVATE9', 'SpeechGrammarState', 'DISPID_SGRSTWeight',
    'DISPID_SOTDisplayUI', 'eLEXTYPE_PRIVATE11', 'DISPID_SVDisplayUI',
    'DISPID_SPIRetainedSizeBytes', 'DISPID_SRGId',
    'DISPID_SVGetVoices', 'DISPID_SVEWord', 'SPEI_RESERVED1',
    'DISPID_SWFEChannels', 'SPINTERFERENCE_LATENCY_WARNING',
    'SAFTGSM610_8kHzMono', 'SpeechVoicePriority', 'SPPHRASEELEMENT',
    'SpeechVoiceSkipTypeSentence', 'DISPIDSPTSI_ActiveLength',
    'SAFT12kHz8BitMono', 'SPEI_RESERVED5',
    'SpeechDictationTopicSpelling',
    'SpeechGrammarTagUnlimitedDictation', 'SGRSTTWord',
    'DISPID_SPEDisplayAttributes', 'DISPID_SPRulesCount',
    'ISpeechRecoContext', 'DISPIDSPTSI_ActiveOffset',
    'DISPID_SRAllowAudioInputFormatChangesOnNextSet', 'SPPS_LMA',
    'ISpStream', 'DISPID_SVResume',
    '__MIDL___MIDL_itf_sapi_0000_0020_0001',
    'DISPID_SOTRemoveStorageFileName', 'DISPID_SpeechVoiceEvent',
    'SP_VISEME_11', 'DISPID_SRRSaveToMemory', 'SP_VISEME_19',
    'SPRS_ACTIVE', 'DISPID_SVSLastStreamNumberQueued',
    'SAFTNoAssignedFormat', 'IInternetSecurityManager',
    'DISPID_SPPParent', 'DISPID_SLWLangId', 'SVP_16',
    'SAFT44kHz8BitStereo', 'DISPID_SPAPhraseInfo',
    'SPDATAKEYLOCATION', 'Speech_Max_Pron_Length',
    'DISPID_SRCRecognizer', 'DISPID_SGRSAddRuleTransition',
    'SGPronounciation', 'ISpeechPhraseProperties',
    'SAFT12kHz16BitStereo', 'SPDKL_LocalMachine', 'SPVPRI_OVER',
    ...
    'DISPID_SGRSTPropertyId', 'ISpeechAudioFormat',
    'DISPID_SPEAudioSizeTime', 'DISPID_SFSClose', 'SPSHORTCUTTYPE',
    'SPSMF_SRGS_SEMANTICINTERPRETATION_W3C', 'DISPID_SVVolume',
    'SP_VISEME_5', 'SECFEmulateResult', 'DISPID_SGRSTsItem',
    'SPCT_SUB_DICTATION', 'SVF_Emphasis', 'SGRSTTTextBuffer',
    'DISPID_SPPsItem', 'DISPID_SLWType', 'DISPID_SADefaultFormat',
    'DISPID_SRGetRecognizers', 'DISPID_SPIEnginePrivateData',
    'SPCT_DICTATION', 'SVSFDefault', 'DISPID_SpeechRecoResult2',
    'DISPID_SGRAddState', 'SpeechTokenContext',
    'SpeechEngineConfidence', 'SP_VISEME_21', 'SP_VISEME_18',
    ...
    'SREStreamStart', 'SLOStatic', 'SpTextSelectionInformation',
    'SPSTREAMFORMATTYPE', 'DISPID_SPEActualConfidence',
    'SDA_Consume_Leading_Spaces', 'eLEXTYPE_RESERVED9',
    'DISPID_SLAddPronunciation', 'SFTInput', 'SPGRAMMARWORDTYPE',
    'SSTTTextBuffer', 'DISPID_SRRAlternates', 'SPPS_RESERVED4',
    'ISpeechGrammarRuleStateTransition',
    'SWPUnknownWordUnpronounceable', 'ISpeechPhoneConverter',
    'SPEI_SR_BOOKMARK', 'DISPIDSPRG', 'SPPS_RESERVED1', 'SPSHT_EMAIL',
    'eWORDTYPE_ADDED', 'SPEI_MIN_SR', 'eLEXTYPE_RESERVED4',
    'SVSFIsNotXML', 'STCInprocHandler', 'DISPID_SVEVoiceChange',
    'SPAR_Medium', 'DISPID_SRRPhraseInfo', 'SDKLLocalMachine',
    'STCRemoteServer', 'SRSActive', 'DISPID_SAVolume',
    'SPFM_CREATE_ALWAYS', 'DISPID_SpeechAudioStatus',
    'eWORDTYPE_DELETED', 'SPCONTEXTSTATE', 'SAFT44kHz8BitMono',
    'SECFIgnoreWidth', 'SpeechRecoProfileProperties',
    'SPSNotOverriden', 'ISpPhoneConverter', 'SVP_13', 'SVEAllEvents',
    'DISPID_SpeechLexiconPronunciation', 'SPPHRASEREPLACEMENT',
    'DISPID_SPIGrammarId', 'DISPID_SPRuleNumberOfElements',
    'SVPNormal', 'DISPID_SFSOpen', 'SPPS_Verb', 'eLEXTYPE_PRIVATE13',
    'SPWT_LEXICAL', 'SSSPTRelativeToEnd', 'SPSVerb', 'SpObjectToken',
    'DISPID_SRCEStartStream', 'DISPID_SPRuleChildren', 'SREBookmark',
    ...
    'DISPID_SRSetPropertyString', 'DISPID_SRCEFalseRecognition',
    'DISPID_SpeechPhraseRules', 'SP_VISEME_20', 'ISpeechObjectTokens',
    'SAFTADPCM_8kHzMono', 'SVSFUnusedFlags', 'eLEXTYPE_PRIVATE10',
    'DISPID_SLPsCount', 'DISPID_SVRate', 'SREPrivate',
    'DISPID_SPIGetText', 'SPRULE', 'DISPID_SGRSAddSpecialTransition',
    'SAFT32kHz16BitStereo', 'SPRULESTATE', 'STSF_FlagCreate',
    'DISPID_SRGState', 'SVP_21', 'DISPID_SVIsUISupported',
    'SPINTERFERENCE', 'DISPID_SPPConfidence', 'ISpeechPhraseRules',
    'DISPID_SLPs_NewEnum', 'DISPID_SAStatus', 'SPBO_TIME_UNITS',
    'DISPID_SGRsCommitAndSave', 'ISpVoice', 'SpInProcRecoContext',
    'eLEXTYPE_PRIVATE15', 'ISpeechWaveFormatEx', 'SPCATEGORYTYPE',
    'tagSTATSTG', 'SRTStandard', 'SpNullPhoneConverter',
    'DISPID_SOTGetAttribute', 'SPGS_DISABLED', 'SPAR_Low',
    'DISPID_SRCRequestedUIType', 'DISPID_SRCCreateResultFromMemory',
    'DISPID_SpeechPhoneConverter', 'SpeechEmulationCompareFlags',
    'DISPID_SRGCmdSetRuleState', 'DISPID_SGRSAddWordTransition',
    'SDKLCurrentUser', 'DISPID_SpeechPhraseElement',
    'SpeechUserTraining', 'ISpeechGrammarRuleStateTransitions',
    'SPINTERFERENCE_TOOQUIET', 'SPSEMANTICERRORINFO',
    'DISPID_SpeechPhraseAlternate', 'SPEI_WORD_BOUNDARY',
    'SpeechStreamSeekPositionType', 'SpeechDiscardType',
    'DISPID_SGRName', 'SVEStartInputStream', 'DISPID_SMSGetData',
    'SPINTERFERENCE_TOOSLOW', 'SSFMOpenForRead', 'DISPID_SRProfile',
    'DISPID_SRRSpeakAudio', 'SPEI_RECOGNITION', 'SGSEnabled',
    'SpeechVoiceSpeakFlags', 'DISPID_SOTCreateInstance',
    'SVSFParseSapi', 'DISPID_SRGCommit', 'SPFM_NUM_MODES',
    'DISPID_SVSpeakCompleteEvent', 'DISPID_SRRGetXMLResult',
    'DISPID_SPEAudioTimeOffset', 'DISPID_SRCEHypothesis',
    'SAFT8kHz8BitMono', 'SGDisplay', 'SAFT16kHz8BitStereo',
    'SPAS_RUN', 'DISPID_SOTCId', 'SpeechCategoryVoices',
    'DISPID_SVAudioOutput', 'SAFT32kHz8BitMono',
    'DISPID_SLPPartOfSpeech', 'SpeechMicTraining',
    'SAFTGSM610_22kHzMono', 'SPFM_CREATE', 'SPSHT_Unknown',
    'SPSModifier', 'SPBO_NONE', 'SAFTCCITT_uLaw_22kHzMono', 'SVP_9',
    'DISPID_SABufferNotifySize', 'DISPID_SABIMinNotification',
    'DISPID_SPPName', 'DISPID_SLWsItem', 'SPWF_INPUT',
    'SPEI_PROPERTY_STRING_CHANGE', 'DISPID_SVSVisemeId',
    'SAFT11kHz8BitMono', 'Speech_Max_Word_Length', 'SDTPronunciation',
    'DISPID_SVPriority', 'SREPhraseStart', 'DISPID_SRCERecognition',
    'SPDKL_CurrentUser', 'WAVEFORMATEX', 'ISpRecoGrammar2',
    'SGSDisabled', 'SSFMOpenReadWrite', 'SAFTExtendedAudioFormat',
    'DISPID_SVEAudioLevel', 'DISPID_SREmulateRecognition',
    'DISPID_SVSRunningState', 'DISPID_SpeechObjectTokenCategory',
    'DISPID_SRCreateRecoContext', 'SpeechRecoEvents',
    'DISPID_SMSSetData', 'SPSHORTCUTPAIRLIST', 'SRTEmulated',
    'SPSERIALIZEDPHRASE', 'DISPID_SRCERecognizerStateChange',
    'SPBOOKMARKOPTIONS', 'eLEXTYPE_RESERVED8',
    'SPINTERFERENCE_TOOLOUD', 'eLEXTYPE_PRIVATE17',
    'DISPID_SpeechLexiconProns', 'DISPID_SRIsShared',
    'DISPID_SPIElements', 'DISPID_SRGSetTextSelection',
    'SREAudioLevel', 'SPWP_UNKNOWN_WORD_UNPRONOUNCEABLE',
    'SECFIgnoreKanaType', 'DISPID_SLWs_NewEnum',
    'SPSMF_SRGS_SAPIPROPERTIES', 'SPPS_Modifier', 'SRESoundEnd',
    'DISPID_SBSSeek', 'DISPID_SVStatus', 'DISPID_SVEStreamEnd',
    'DISPID_SPPId', 'DISPID_SABIEventBias', 'DISPID_SGRSTransitions',
    'SP_VISEME_16', 'SAFTCCITT_ALaw_8kHzStereo', 'SPPHRASE',
    'ISpShortcut', 'DISPID_SRCRetainedAudio', 'SpeechAddRemoveWord',
    'DISPID_SpeechRecoContext', 'ISpeechPhraseInfoBuilder',
    'SPEI_RESERVED6', 'SAFT12kHz16BitMono', 'DISPID_SRCEAudioLevel',
    'ISpeechLexicon', 'SPGRAMMARSTATE', 'SRTAutopause',
    'DISPID_SOTs_NewEnum', 'DISPID_SPRuleFirstElement',
    'SAFT24kHz8BitStereo', 'SpResourceManager', 'SPCT_SUB_COMMAND',
    'DISPID_SGRsCount', 'SpeechRecognitionType',
    'SAFTTrueSpeech_8kHz1BitMono', 'DISPID_SBSWrite', 'SASRun',
    'DISPID_SRGRules', 'DISPID_SRCEInterference',
    'DISPID_SpeechLexiconWords', 'SAFT16kHz8BitMono',
    'ISpSerializeState', 'DISPID_SAEventHandle',
    'DISPID_SASNonBlockingIO', 'SLTUser',
    'SAFTCCITT_ALaw_22kHzStereo', 'DISPID_SOTMatchesAttributes',
    'SVSFParseMask', 'SPINTERFERENCE_NOSIGNAL', 'ISpeechObjectToken',
    'SPEI_START_INPUT_STREAM', 'DISPID_SpeechPhraseReplacement',
    'DISPID_SLWPronunciations', 'SVSFNLPMask',
    'SpeechRegistryUserRoot', 'DISPID_SVSLastBookmarkId',
    'SAFT24kHz16BitStereo', 'SpStreamFormatConverter',
    'SpeechWordType', 'SP_VISEME_14', 'SDTAlternates',
    'SAFT8kHz16BitMono', 'SPVOICESTATUS', 'SPEI_VISEME',
    'SpWaveFormatEx', 'SPGS_ENABLED', 'DISPID_SRGetPropertyNumber',
    'SAFT22kHz16BitStereo', 'DISPID_SGRSTs_NewEnum',
    'SpeechTokenShellFolder', 'SPCS_ENABLED', 'SPVISEMES',
    'SVF_Stressed', 'ISpeechPhraseProperty',
    'DISPID_SRGCmdSetRuleIdState', 'DISPID_SVEStreamStart',
    ...
    'DISPID_SPERequiredConfidence', 'DISPID_SOTsCount',
    'SPEI_RECO_OTHER_CONTEXT', 'DISPID_SLPsItem', 'SAFT24kHz8BitMono',
    'SpeechTokenKeyAttributes', 'SRTExtendableParse',
    'ISpeechRecognizer', 'SRTReSent', 'SPEI_MAX_TTS', 'SITooFast',
    'DISPID_SGRSTPropertyValue', 'SPEI_INTERFERENCE', 'SPWF_SRENGINE',
    'ISpNotifyTranslator', 'DISPID_SRCESoundStart',
    'SAFT22kHz8BitMono', 'SDA_No_Trailing_Space',
    'DISPID_SPEAudioStreamOffset', 'SpNotifyTranslator',
    'DISPID_SRGCmdLoadFromResource', 'DISPID_SLPLangId',
    'SAFTCCITT_uLaw_8kHzStereo', 'DISPID_SpeechVoiceStatus',
    'DISPID_SASCurrentDevicePosition', 'ISpeechObjectTokenCategory',
    'SVP_1', 'SPAUDIOBUFFERINFO', 'DISPID_SPCPhoneToId',
    'SPVPRI_NORMAL', 'SGSExclusive', 'SLODynamic',
    'SpeechGrammarRuleStateTransitionType', 'SECFDefault',
    '_ISpeechVoiceEvents', 'SSFMCreateForWrite', 'SGDSActive',
    'DISPID_SMSAMMHandle', 'SPLEXICONTYPE',
    'DISPID_SpeechGrammarRules', 'DISPID_SOTsItem',
    'ISpeechLexiconPronunciations', 'SPSHORTCUTPAIR', 'SPFILEMODE',
    'SVP_14', 'SP_VISEME_9', 'DISPID_SDKSetLongValue',
    'SPXMLRESULTOPTIONS', 'SWPKnownWordPronounceable',
    'DISPID_SRGCmdLoadFromObject', '_ISpeechRecoContextEvents',
    'ISpPhoneticAlphabetConverter', 'SVSFParseAutodetect',
    'SDA_Two_Trailing_Spaces', 'DISPID_SRGCmdLoadFromMemory',
    'DISPID_SRRecognizer', 'DISPID_SPRules_NewEnum', 'SpMMAudioOut',
    'DISPID_SVWaitUntilDone', 'SpUnCompressedLexicon', 'SITooQuiet',
    'DISPID_SpeechAudio', 'SAFT16kHz16BitMono',
    'SAFTCCITT_uLaw_22kHzStereo', 'SVP_11', 'DISPID_SCSBaseStream',
    'STCLocalServer', 'SPTEXTSELECTIONINFO',
    'DISPID_SRCERecognitionForOtherContext', 'SAFT48kHz16BitMono',
    'SpInprocRecognizer', 'SPWORDPRONOUNCEABLE', 'SpMMAudioIn',
    'DISPID_SPRulesItem', 'DISPID_SLRemovePronunciationByPhoneIds',
    'SDKLDefaultLocation', 'SVP_7', 'SPRECORESULTTIMES',
    'eLEXTYPE_PRIVATE6', 'DISPID_SBSFormat', 'SPRST_NUM_STATES',
    'DISPID_SDKSetStringValue', 'SPEI_PROPERTY_NUM_CHANGE',
    'DISPID_SASetState', 'DISPID_SRState', 'DISPID_SRIsUISupported',
    'DISPID_SRRAudioFormat', 'SPEI_RESERVED2', 'DISPID_SAFGuid',
    'SPEI_TTS_PRIVATE', 'SVSFVoiceMask', 'SDTAll',
    'SAFT48kHz8BitMono', 'SpeechAudioFormatGUIDWave',
    'SPWT_LEXICAL_NO_SPECIAL_CHARS', 'DISPID_SpeechAudioBufferInfo',
    'SpeechAudioVolume', 'SPDKL_DefaultLocation',
    'ISpeechPhraseElements', 'ISpeechLexiconWord',
    'SAFTCCITT_ALaw_11kHzStereo', 'SRAONone', 'DISPID_SPIEngineId',
    'ISpeechAudioBufferInfo', 'DISPID_SVPause',
    'DISPID_SpeechAudioFormat', 'DISPID_SOTGetStorageFileName',
    'DISPID_SRAudioInputStream', 'ISpeechMMSysAudio',
    'DISPID_SpeechPhraseRule', 'SRAExport', 'DISPID_SOTRemove',
    'SINone', 'SPAUDIOSTATE', 'SVEVoiceChange', 'SPEI_END_SR_STREAM',
    'SP_VISEME_7', 'ISpLexicon', 'SPSERIALIZEDRESULT',
    'DISPID_SVEPhoneme', 'SRAImport', 'DISPID_SRStatus', 'SLTApp',
    'DISPID_SGRInitialState', 'SRAORetainAudio', 'SAFTDefault',
    'SPEI_SOUND_END', 'SPRECOCONTEXTSTATUS', 'SVP_19',
    'DISPID_SASState', 'DISPID_SGRSTsCount',
    'SPWORDPRONUNCIATIONLIST', 'ISpeechRecoGrammar',
    'ISpeechPhraseAlternates', 'DISPID_SRCEPhraseStart',
    'DISPID_SWFEFormatTag', 'SREHypothesis', 'SRESoundStart',
    'SpeechPropertyHighConfidenceThreshold', 'SRATopLevel',
    'SPSMF_UPS', 'DISPID_SPEs_NewEnum', 'SAFT22kHz8BitStereo',
    'SAFTCCITT_ALaw_11kHzMono', 'SAFTCCITT_uLaw_44kHzStereo',
    'SPRS_ACTIVE_USER_DELIMITED', 'SRAInterpreter', 'SPSSuppressWord',
    'DISPID_SGRAddResource', 'SpeechGrammarTagDictation',
    'SPVPRIORITY', 'SPWP_KNOWN_WORD_PRONOUNCEABLE',
    'STSF_CommonAppData', 'SPBINARYGRAMMAR', 'DISPID_SDKDeleteKey',
    'ISpResourceManager', 'SpeechAllElements', 'DISPID_SDKEnumValues',
    'ISpeechPhraseInfo', 'SPFM_OPEN_READONLY', 'SECFNoSpecialChars',
    'SP_VISEME_0', 'DISPID_SpeechRecoResult', 'ISpRecognizer',
    'DISPID_SASFreeBufferSpace', 'ISpRecoContext2',
    'DISPID_SOTGetDescription', 'eLEXTYPE_RESERVED6',
    'DISPID_SRCEEnginePrivate', 'SRSInactiveWithPurge',
    'DISPID_SGRsFindRule', 'SPEI_FALSE_RECOGNITION',
    '__MIDL_IWinTypes_0009', 'SPRECOSTATE', 'DISPID_SRCESoundEnd',
    'DISPID_SPRText', 'SPBO_PAUSE', 'SPGS_EXCLUSIVE',
    'DISPID_SPAStartElementInResult', 'SpStream',
    'DISPID_SASCurrentSeekPosition', 'SVEPrivate', 'SPSFunction',
    'DISPID_SDKDeleteValue', 'SVP_10', 'SPCS_DISABLED',
    'SpeechRuleState', 'SRADefaultToActive',
    'DISPID_SRCRetainedAudioFormat', 'DISPID_SLGetWords',
    'ISpeechRecognizerStatus', 'SFTSREngine', 'SRTSMLTimeout',
    'ISpeechGrammarRules', 'DISPID_SGRSTType', 'SDTAudio',
    'eLEXTYPE_PRIVATE4', 'ISpPhoneticAlphabetSelection',
    'DISPID_SVSpeak', 'SPPHRASEPROPERTY', 'ISpeechXMLRecoResult',
    ...
    'DISPID_SRCVoicePurgeEvent', 'SP_VISEME_17',
    'DISPID_SPANumberOfElementsInResult',
    'DISPID_SRRTOffsetFromStart', 'SPLO_DYNAMIC',
    'SpPhoneticAlphabetConverter', 'DISPID_SMSADeviceId',
    'DISPID_SDKEnumKeys', 'SAFTCCITT_ALaw_44kHzStereo',
    'SpeechPropertyComplexResponseSpeed', 'DISPID_SRGetFormat',
    'SAFT8kHz8BitStereo', 'ISpDataKey', 'SpeechVisemeFeature',
    'SSTTWildcard', 'SPEI_START_SR_STREAM', 'SAFT24kHz16BitMono',
    'DISPID_SVSkip', 'SAFTADPCM_11kHzMono', 'SPRST_INACTIVE',
    'DISPID_SRCEPropertyNumberChange', 'SAFT8kHz16BitStereo',
    'SpeechPropertyAdaptationOn', 'ISpeechPhraseRule',
    'SpeechDataKeyLocation', 'SAFT44kHz16BitMono',
    'SpeechRecognizerState', 'SGRSTTWildcard',
    'DISPID_SPRuleConfidence', 'SPINTERFERENCE_NOISE',
    'ISpeechPhraseReplacements', 'SPEI_VOICE_CHANGE',
    'DISPID_SPRuleEngineConfidence', 'DISPID_SGRSTRule', 'SASPause',
    'eLEXTYPE_PRIVATE12', 'DISPID_SRSNumberOfActiveRules',
    'SDTLexicalForm', 'DISPID_SAFType', 'SpPhoneConverter',
    'LONG_PTR', 'SINoise', 'SAFT22kHz16BitMono',
    'DISPID_SPIReplacements', 'SPEVENTSOURCEINFO',
    'ISpeechPhraseElement', 'DISPID_SPPsCount', 'SPAS_PAUSE',
    'SPDKL_CurrentConfig', 'SPLOADOPTIONS', 'SDTProperty',
    'DISPID_SRGDictationSetState', 'DISPID_SVSPhonemeId',
    'DISPID_SRCBookmark', 'SDTReplacement', 'SPAR_Unknown',
    'DISPID_SpeechLexiconWord', 'IEnumString', 'ISpObjectToken',
    'DISPID_SRRTLength', 'DISPID_SRDisplayUI', 'DISPID_SPRsCount',
    'ISpMMSysAudio', 'ISpRecoContext', 'DISPID_SPPs_NewEnum',
    'DISPID_SDKSetBinaryValue', 'SP_VISEME_4', 'SPPS_Function',
    'DISPID_SpeechMMSysAudio', 'SVSFPurgeBeforeSpeak',
    'ISpGrammarBuilder', 'SAFTText', 'SAFTCCITT_ALaw_44kHzMono',
    'SPRST_ACTIVE_ALWAYS', 'eLEXTYPE_USER', 'SAFT48kHz8BitStereo',
    'SPWORDLIST', 'SpPhraseInfoBuilder', 'SVEEndInputStream',
    'SP_VISEME_13', 'SpeechWordPronounceable', 'SVEBookmark',
    'ISpeechResourceLoader', 'SINoSignal', 'DISPID_SVEEnginePrivate',
    'DISPID_SpeechRecoContextEvents', 'ISpeechGrammarRuleState',
    'DISPID_SRSetPropertyNumber', 'SP_VISEME_8',
    'DISPID_SRCEEndStream', 'ISpStreamFormatConverter',
    'SRERecognition', 'SREAllEvents', 'DISPID_SGRId',
    'SREPropertyStringChange', 'ISpeechRecoResult', 'SPPS_Noun',
    'DISPID_SGRsCommit', 'SAFTCCITT_uLaw_44kHzMono',
    'SpCompressedLexicon', 'SpShortcut',
    'SpeechRegistryLocalMachineRoot', '_RemotableHandle',
    'SPRECOGNIZERSTATUS', 'SGDSInactive', 'DISPID_SRRAudio',
    'SPBO_AHEAD', 'SGLexical', 'STSF_LocalAppData',
    'SpeechVoiceEvents', 'tagSPPROPERTYINFO', 'SVP_4',
    'SpObjectTokenCategory', 'SPPHRASERULE', 'ISpRecognizer3',
    'SpeechVoiceCategoryTTSRate', 'SpeechFormatType',
    'SAFT11kHz16BitMono', 'DISPID_SVESentenceBoundary',
    'SREFalseRecognition', 'SGRSTTEpsilon', 'SDA_One_Trailing_Space',
    'SpeechRetainedAudioOptions', 'DISPID_SVSInputSentencePosition',
    'ISpeechAudioStatus', 'SPPS_RESERVED2',
    'DISPID_SOTCEnumerateTokens', 'DISPID_SPEDisplayText',
    'SPAS_STOP', 'SDKLCurrentConfig', 'SPEI_UNDEFINED', 'SWTAdded',
    'DISPID_SGRsItem', 'SRERequestUI', 'SPSLMA', 'SPPARTOFSPEECH',
    'DISPID_SPIProperties', 'DISPID_SPAsItem',
    'DISPID_SPPBRestorePhraseFromMemory', 'DISPID_SPRuleId',
    'DISPID_SRCEBookmark', 'SRARoot', 'SPPS_SuppressWord',
    ...
    'DISPID_SRCCmdMaxAlternates', 'DISPID_SVEBookmark', 'SPAO_NONE',
    'DISPID_SpeechRecognizer', 'SPSEMANTICFORMAT',
    'SAFTADPCM_22kHzMono', 'DISPID_SPRuleParent', 'IStream',
    'DISPID_SVVoice', 'SPINTERFERENCE_LATENCY_TRUNCATE_BEGIN',
    'SpeechStreamFileMode', 'SpeechAudioProperties',
    'DISPID_SVSLastResult', 'SPAO_RETAIN_AUDIO', 'SP_VISEME_6',
    'SP_VISEME_2', 'SREStateChange', 'DISPID_SGRClear',
    'tagSPTEXTSELECTIONINFO', 'eLEXTYPE_MORPHOLOGY',
    'DISPID_SRCEAdaptation', 'DISPID_SDKGetBinaryValue',
    'eLEXTYPE_USER_SHORTCUT', 'SVEAudioLevel',
    'DISPID_SDKGetlongValue', 'SVP_2', 'DISPID_SVSInputWordLength',
    'SSTTDictation', 'SpeechCategoryRecoProfiles',
    'SpeechPropertyResponseSpeed', 'SpeechAudioFormatType', 'SVP_6',
    'ISpAudio', 'DISPID_SPEPronunciation', 'DISPID_SABIBufferSize',
    'DISPID_SRGSetWordSequenceData', 'SPSHT_NotOverriden',
    'SpeechCategoryRecognizers', 'DISPID_SpeechGrammarRule',
    'SPPS_Unknown', 'SPWP_UNKNOWN_WORD_PRONOUNCEABLE', 'SPAR_High',
    'SPSInterjection', 'DISPID_SGRAttributes', 'DISPID_SVEViseme',
    'ISpRecognizer2', 'DISPID_SLGetPronunciations', 'SP_VISEME_12',
    'SVESentenceBoundary', 'ISpNotifySource', '_SPAUDIOSTATE',
    'DISPID_SWFEExtraData', 'IInternetSecurityMgrSite',
    'DISPID_SRCVoice', 'eLEXTYPE_PRIVATE8',
    'ISpeechLexiconPronunciation', 'DISPID_SRCEPropertyStringChange',
    'SpeechTokenKeyFiles', 'SVP_8', 'SVPOver', 'SPEI_REQUEST_UI',
    'SpSharedRecognizer', 'SPSMF_SRGS_SEMANTICINTERPRETATION_MS',
    'SITooSlow', 'DISPID_SVEventInterests', 'SECHighConfidence',
    'SRCS_Enabled', 'ISpeechRecoResultDispatch',
    'DISPID_SPERetainedStreamOffset', 'SAFTCCITT_uLaw_8kHzMono',
    'DISPID_SDKOpenKey', 'SVF_None', 'SpeechEngineProperties',
    'SPSUnknown', 'SVSFIsFilename', 'SSSPTRelativeToStart',
    'DISPID_SVGetAudioInputs', 'SVPAlert', 'SPCT_COMMAND',
    'DISPID_SPCLangId', 'DISPID_SAFGetWaveFormatEx', 'SSFMCreate',
    'SpeechAudioState', 'SpMemoryStream',
    'DISPID_SpeechRecoResultTimes', 'DISPID_SRGetPropertyString',
    'DISPID_SPPNumberOfElements', 'DISPID_SAFSetWaveFormatEx',
    'SAFT32kHz16BitMono', 'SPEI_PHRASE_START', 'SAFTGSM610_11kHzMono',
    'DISPID_SRRTStreamTime', 'DISPID_SPIStartTime', 'SVSFlagsAsync',
    'DISPID_SRGDictationLoad', 'SECFIgnoreCase', 'ISpeechBaseStream',
    'SVSFIsXML', 'SGRSTTDictation',
    '__MIDL___MIDL_itf_sapi_0000_0020_0002', 'ISpRecoCategory',
    'DISPID_SVGetAudioOutputs', 'SpeechTokenIdUserLexicon',
    'SPEVENTENUM', 'ISpeechAudio', 'DISPID_SBSRead',
    'DISPID_SPEsItem', 'DISPID_SpeechGrammarRuleStateTransition',
    'SPCT_SLEEP', 'SWTDeleted', 'SAFTCCITT_ALaw_22kHzMono',
    'ISpObjectWithToken', 'DISPID_SpeechMemoryStream',
    'DISPID_SLPSymbolic', 'DISPID_SRGDictationUnload', 'ISpPhraseAlt',
    'IEnumSpObjectTokens', 'SpeechAudioFormatGUIDText',
    'ISpeechDataKey', 'DISPID_SVAudioOutputStream', 'SVP_18',
    'SpeechVisemeType', 'SP_VISEME_10', 'ISpStreamFormat',
    'ISpXMLRecoResult', 'eLEXTYPE_RESERVED10', 'DISPID_SVSpeakStream',
    'SAFT12kHz8BitStereo', 'eLEXTYPE_APP', 'SGRSTTRule',
    'SpeechTokenKeyUI', 'DISPID_SPIAudioStreamPosition',
    'DISPID_SpeechGrammarRuleState', 'SPWT_PRONUNCIATION',
    'DISPID_SPIAudioSizeBytes', 'SpeechLoadOption',
    'SPEI_SOUND_START', 'DISPID_SPRuleName', 'DISPID_SRGReset',
    'SpFileStream', 'SDTRule', 'DISPID_SpeechVoice', 'SpeechRunState',
    'SVP_20', 'SREInterference', 'ISpeechCustomStream',
    'SVSFNLPSpeakPunc', 'SPEI_SENTENCE_BOUNDARY', 'SPAUDIOSTATUS',
    'SAFT32kHz8BitStereo', 'DISPID_SGRSRule',
    'SGLexicalNoSpecialChars'
]

_check_version('1.2.0', 1701111041.348221)
